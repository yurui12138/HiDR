...
def base_network(input_shape,params,dropo):
...
def siamese_model(params,drop):
    input_shape = (input_dim,)

    base_net = base_network(input_shape,params,drop)
...
def train(params,drop):
    ...
    model = siamese_model(params,drop)
...
if __name__ == '__main__':
    ...
    drop = 0.2
    params = {'learning_rate': 0.0019368014216827824, 'hid_dim': 400, 'conv_filters': 64, 'conv12_kenel': 4,
              'conv12_strides': 3, 'conv3_kenel': 3, 'conv3_strides': 2, 'optimizer': 'RMSprop', 'loss': 'msle'}
    train(params,drop)
