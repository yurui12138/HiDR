...
train_q1, train_q2, train_label = read_data('./IC/cut_word/IC_train1.txt')
test_q1, test_q2, test_label = read_data('./IC/cut_word/IC_test1.txt')
dev_q1, dev_q2, dev_label = read_data('./IC/cut_word/IC_dev1.txt')
